      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {bankingPartners.map((bank) => (
              ...
              >
                <Building className="w-8 h-8 text-foreground mx-auto mb-2" />
        ...
        <div className="bg-white rounded-2xl p-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-6">Eligibility Criteria</h3>
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-foreground">Employment</h4>
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-foreground">Credit Score</h4>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <FileText className="w-5 h-5 text-text mr-3" />
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">Simple Finance Process</h3>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Apply Online</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Document Upload</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Instant Approval</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">Drive Home</h4>
