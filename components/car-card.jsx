...
export const CarCard = memo(function CarCard({ car }) {
  ...
  // ✅ Update saved state when car prop changes (so it resets properly after refresh)
  useEffect(() => {
  ...
  const handleToggleSave = async (e) => {
    e.preventDefault();
    e.stopPropagation(); // prevent click from triggering card link
  ...
  return (
    // ✅ Make entire card clickable using Link wrapper
    <Link href={`/cars/${car.id}`} className="block group">
      <Card className="overflow-hidden hover:shadow-lg transition relative group cursor-pointer">
